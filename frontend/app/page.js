    ...
    <main className="min-h-screen bg-gray-50 py-10 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-4">
          {posts.length === 0 ? (
            <p className="text-center text-gray-500">아직 등록된 다짐이 없습니다. 첫 번째 다짐을 남겨보세요!</p>
          ) : (
            posts.map((post) => (
              <div key={post.id} className="bg-white p-5 rounded-lg shadow-sm border border-gray-100 flex justify-between items-center hover:shadow-md transition-shadow">
                <div>
